...
pub async fn admin_cluster_get_server_ips(
	configuration: &configuration::Configuration,
	server_id: Option<&str>,
	pool: Option<crate::models::AdminPoolType>,
) -> Result<crate::models::AdminClusterGetServerIpsResponse, Error<AdminClusterGetServerIpsError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<AdminClusterGetServerIpsError> =
