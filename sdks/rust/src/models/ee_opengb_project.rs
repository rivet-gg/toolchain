...
impl EeOpengbProject {
    pub fn new(create_ts: String, developer_group_id: uuid::Uuid, display_name: String, name_id: String, project_id: uuid::Uuid) -> EeOpengbProject {
        EeOpengbProject {
            create_ts,
            developer_group_id,
            display_name,
