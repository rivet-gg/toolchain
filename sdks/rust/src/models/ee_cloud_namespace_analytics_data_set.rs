...
pub struct EeCloudNamespaceAnalyticsDataSet {
    ...
    #[serde(rename = "avg_play_duration_by_game_mode", skip_serializing_if = "Option::is_none")]
    pub avg_play_duration_by_game_mode: Option<Box<crate::models::EeCloudAvgPlayDurationByGameModeDataSet>>,
    #[serde(rename = "avg_play_duration_by_region", skip_serializing_if = "Option::is_none")]
    pub avg_play_duration_by_region: Option<Box<crate::models::EeCloudAvgPlayDurationByRegionDataSet>>,
    #[serde(rename = "destroyed_lobbies_by_exit_code", skip_serializing_if = "Option::is_none")]
    pub destroyed_lobbies_by_exit_code: Option<Box<crate::models::EeCloudDestroyedLobbiesByExitCodeDataSet>>,
    #[serde(rename = "destroyed_lobbies_by_failure", skip_serializing_if = "Option::is_none")]
    pub destroyed_lobbies_by_failure: Option<Box<crate::models::EeCloudDestroyedLobbiesByFailureDataSet>>,
    ...
    #[serde(rename = "lobby_count_by_game_mode", skip_serializing_if = "Option::is_none")]
    pub lobby_count_by_game_mode: Option<Box<crate::models::EeCloudLobbyCountByGameModeDataSet>>,
    #[serde(rename = "lobby_count_by_region", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "matchmaker_overview", skip_serializing_if = "Option::is_none")]
    pub matchmaker_overview: Option<Box<crate::models::EeCloudMatchmakerOverviewDataSet>>,
    #[serde(rename = "new_lobbies_per_second", skip_serializing_if = "Option::is_none")]
    pub new_lobbies_per_second: Option<Box<crate::models::EeCloudNewLobbiesPerSecondDataSet>>,
    #[serde(rename = "new_players_per_second", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "player_count_by_game_mode", skip_serializing_if = "Option::is_none")]
    pub player_count_by_game_mode: Option<Box<crate::models::EeCloudPlayerCountByGameModeDataSet>>,
    #[serde(rename = "player_count_by_region", skip_serializing_if = "Option::is_none")]
