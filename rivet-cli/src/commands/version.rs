...
async fn print_version(ctx: &toolchain_core::Ctx, version_id: &str) -> GlobalResult<()> {
...
pub fn dashboard_url(ctx: &toolchain_core::Ctx, game_id: &str, version_id: &str) -> String {
	format!(
