...
/// Creates a new party.
pub async fn party_parties_create(configuration: &configuration::Configuration, party_create_input: crate::models::PartyCreateInput) -> Result<crate::models::PartyCreateOutput, Error<PartyPartiesCreateError>> {
...
pub async fn party_parties_create_invite(configuration: &configuration::Configuration, party_create_invite_input: crate::models::PartyCreateInviteInput) -> Result<crate::models::PartyCreateInviteOutput, Error<PartyPartiesCreateInviteError>> {
    let local_var_configuration = configuration;
...
pub async fn party_parties_get_from_invite(configuration: &configuration::Configuration, token: Option<&str>, alias: Option<&str>) -> Result<crate::models::PartyGetInviteOutput, Error<PartyPartiesGetFromInviteError>> {
    let local_var_configuration = configuration;
...
pub async fn party_parties_get_profile(configuration: &configuration::Configuration, party_id: &str, watch_index: Option<&str>) -> Result<crate::models::PartyGetProfileOutput, Error<PartyPartiesGetProfileError>> {
    let local_var_configuration = configuration;
...
pub async fn party_parties_get_self_profile(configuration: &configuration::Configuration, watch_index: Option<&str>) -> Result<crate::models::PartyGetSelfProfileOutput, Error<PartyPartiesGetSelfProfileError>> {
    let local_var_configuration = configuration;
...
pub async fn party_parties_get_self_summary(configuration: &configuration::Configuration, watch_index: Option<&str>) -> Result<crate::models::PartyGetSelfSummaryOutput, Error<PartyPartiesGetSelfSummaryError>> {
    let local_var_configuration = configuration;
...
pub async fn party_parties_get_summary(configuration: &configuration::Configuration, party_id: &str, watch_index: Option<&str>) -> Result<crate::models::PartyGetSummaryOutput, Error<PartyPartiesGetSummaryError>> {
    let local_var_configuration = configuration;
...
pub async fn party_parties_join(configuration: &configuration::Configuration, party_join_input: crate::models::PartyJoinInput) -> Result<crate::models::PartyJoinOutput, Error<PartyPartiesJoinError>> {
    let local_var_configuration = configuration;
...
pub async fn party_parties_set_publicity(configuration: &configuration::Configuration, party_set_publicity_input: crate::models::PartySetPublicityInput) -> Result<(), Error<PartyPartiesSetPublicityError>> {
    let local_var_configuration = configuration;
