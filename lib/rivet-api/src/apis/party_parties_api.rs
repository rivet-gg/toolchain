...
/// Creates a new party.
pub async fn party_parties_create(
	configuration: &configuration::Configuration,
	party_create_request: crate::models::PartyCreateRequest,
) -> Result<crate::models::PartyCreateResponse, Error<PartyPartiesCreateError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesCreateError> =
...
pub async fn party_parties_create_invite(
	configuration: &configuration::Configuration,
	party_create_invite_request: crate::models::PartyCreateInviteRequest,
) -> Result<crate::models::PartyCreateInviteResponse, Error<PartyPartiesCreateInviteError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesCreateInviteError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn party_parties_get_from_invite(
	configuration: &configuration::Configuration,
	token: Option<&str>,
	alias: Option<&str>,
) -> Result<crate::models::PartyGetInviteResponse, Error<PartyPartiesGetFromInviteError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesGetFromInviteError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn party_parties_get_profile(
	configuration: &configuration::Configuration,
	party_id: &str,
	watch_index: Option<&str>,
) -> Result<crate::models::PartyGetProfileResponse, Error<PartyPartiesGetProfileError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesGetProfileError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn party_parties_get_self_profile(
	configuration: &configuration::Configuration,
	watch_index: Option<&str>,
) -> Result<crate::models::PartyGetSelfProfileResponse, Error<PartyPartiesGetSelfProfileError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesGetSelfProfileError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn party_parties_get_self_summary(
	configuration: &configuration::Configuration,
	watch_index: Option<&str>,
) -> Result<crate::models::PartyGetSelfSummaryResponse, Error<PartyPartiesGetSelfSummaryError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesGetSelfSummaryError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn party_parties_get_summary(
	configuration: &configuration::Configuration,
	party_id: &str,
	watch_index: Option<&str>,
) -> Result<crate::models::PartyGetSummaryResponse, Error<PartyPartiesGetSummaryError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesGetSummaryError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn party_parties_join(
	configuration: &configuration::Configuration,
	party_join_request: crate::models::PartyJoinRequest,
) -> Result<crate::models::PartyJoinResponse, Error<PartyPartiesJoinError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesJoinError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn party_parties_kick_member(
	configuration: &configuration::Configuration,
	identity_id: &str,
) -> Result<(), Error<PartyPartiesKickMemberError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesKickMemberError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn party_parties_leave(
	configuration: &configuration::Configuration,
) -> Result<(), Error<PartyPartiesLeaveError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesLeaveError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn party_parties_revoke_invite(
	configuration: &configuration::Configuration,
	invite_id: &str,
) -> Result<(), Error<PartyPartiesRevokeInviteError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesRevokeInviteError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn party_parties_send_join_request(
	configuration: &configuration::Configuration,
	party_id: &str,
) -> Result<(), Error<PartyPartiesSendJoinRequestError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesSendJoinRequestError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn party_parties_set_publicity(
	configuration: &configuration::Configuration,
	party_set_publicity_request: crate::models::PartySetPublicityRequest,
) -> Result<(), Error<PartyPartiesSetPublicityError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesSetPublicityError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn party_parties_transfer_ownership(
	configuration: &configuration::Configuration,
	identity_id: &str,
) -> Result<(), Error<PartyPartiesTransferOwnershipError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyPartiesTransferOwnershipError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
