...
pub async fn kv_batch_delete_batch(configuration: &configuration::Configuration, namespace_id: Option<&str>) -> Result<(), Error<KvBatchDeleteBatchError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<KvBatchDeleteBatchError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn kv_batch_get_batch(configuration: &configuration::Configuration, watch_index: Option<&str>, namespace_id: Option<&str>) -> Result<crate::models::KvGetBatchOutput, Error<KvBatchGetBatchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<KvBatchGetBatchError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn kv_batch_put_batch(configuration: &configuration::Configuration, kv_put_batch_input: crate::models::KvPutBatchInput) -> Result<(), Error<KvBatchPutBatchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<KvBatchPutBatchError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
