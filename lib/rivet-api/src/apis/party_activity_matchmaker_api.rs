...
pub async fn party_activity_matchmaker_find_lobby_for_party(
	configuration: &configuration::Configuration,
	party_activity_find_matchmaker_lobby_for_party_request: crate::models::PartyActivityFindMatchmakerLobbyForPartyRequest,
) -> Result<(), Error<PartyActivityMatchmakerFindLobbyForPartyError>> {
	...
	local_var_req_builder =
		local_var_req_builder.json(&party_activity_find_matchmaker_lobby_for_party_request);
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyActivityMatchmakerFindLobbyForPartyError> =
...
pub async fn party_activity_matchmaker_join_lobby_for_party(
	configuration: &configuration::Configuration,
	party_activity_join_matchmaker_lobby_for_party_request: crate::models::PartyActivityJoinMatchmakerLobbyForPartyRequest,
) -> Result<(), Error<PartyActivityMatchmakerJoinLobbyForPartyError>> {
	let local_var_configuration = configuration;
	...
	local_var_req_builder =
		local_var_req_builder.json(&party_activity_join_matchmaker_lobby_for_party_request);
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyActivityMatchmakerJoinLobbyForPartyError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn party_activity_matchmaker_request_player(
	configuration: &configuration::Configuration,
) -> Result<(), Error<PartyActivityMatchmakerRequestPlayerError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyActivityMatchmakerRequestPlayerError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
