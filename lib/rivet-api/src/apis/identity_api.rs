...
pub async fn identity_list_recent_followers(configuration: &configuration::Configuration, count: Option<i32>, watch_index: Option<&str>) -> Result<crate::models::IdentityListRecentFollowersOutput, Error<IdentityListRecentFollowersError>> {
    let local_var_configuration = configuration;
