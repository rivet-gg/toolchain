...
pub async fn chat_identity_get_direct_thread(
	configuration: &configuration::Configuration,
	identity_id: &str,
) -> Result<crate::models::ChatGetDirectThreadResponse, Error<ChatIdentityGetDirectThreadError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ChatIdentityGetDirectThreadError> =
