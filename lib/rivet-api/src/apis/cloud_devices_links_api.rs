...
pub async fn cloud_devices_links_complete(configuration: &configuration::Configuration, cloud_devices_complete_device_link_input: crate::models::CloudDevicesCompleteDeviceLinkInput) -> Result<(), Error<CloudDevicesLinksCompleteError>> {
...
pub async fn cloud_devices_links_prepare(configuration: &configuration::Configuration, ) -> Result<crate::models::CloudDevicesPrepareDeviceLinkOutput, Error<CloudDevicesLinksPrepareError>> {
    let local_var_configuration = configuration;
