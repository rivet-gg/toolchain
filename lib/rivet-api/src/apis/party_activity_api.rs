...
pub async fn party_activity_set_party_to_idle(
	configuration: &configuration::Configuration,
) -> Result<(), Error<PartyActivitySetPartyToIdleError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<PartyActivitySetPartyToIdleError> =
