...
pub async fn chat_get_thread_history(
	configuration: &configuration::Configuration,
	thread_id: &str,
	count: f64,
	ts: Option<String>,
	query_direction: Option<&str>,
) -> Result<crate::models::ChatGetThreadHistoryResponse, Error<ChatGetThreadHistoryError>> {
	...
	if let Some(ref local_var_str) = query_direction {
		local_var_req_builder =
			local_var_req_builder.query(&[("query_direction", &local_var_str.to_string())]);
	}
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ChatGetThreadHistoryError> =
...
pub async fn chat_get_thread_topic(
	configuration: &configuration::Configuration,
	thread_id: &str,
) -> Result<crate::models::ChatGetThreadTopicResponse, Error<ChatGetThreadTopicError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ChatGetThreadTopicError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn chat_send_message(
	configuration: &configuration::Configuration,
	chat_send_message_request: crate::models::ChatSendMessageRequest,
) -> Result<crate::models::ChatSendMessageResponse, Error<ChatSendMessageError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ChatSendMessageError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn chat_set_thread_read(
	configuration: &configuration::Configuration,
	thread_id: &str,
	chat_set_thread_read_request: crate::models::ChatSetThreadReadRequest,
) -> Result<(), Error<ChatSetThreadReadError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ChatSetThreadReadError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn chat_set_typing_status(
	configuration: &configuration::Configuration,
	thread_id: &str,
	chat_set_typing_status_request: crate::models::ChatSetTypingStatusRequest,
) -> Result<(), Error<ChatSetTypingStatusError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ChatSetTypingStatusError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn chat_watch_thread(
	configuration: &configuration::Configuration,
	thread_id: &str,
	watch_index: Option<&str>,
) -> Result<crate::models::ChatWatchThreadResponse, Error<ChatWatchThreadError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ChatWatchThreadError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
