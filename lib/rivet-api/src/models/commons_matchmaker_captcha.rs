...
/// CommonsMatchmakerCaptcha : Matchmaker captcha configuration.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CommonsMatchmakerCaptcha {
    ...
    pub hcaptcha: Option<Box<crate::models::CommonsMatchmakerCaptchaHcaptcha>>,
}

impl CommonsMatchmakerCaptcha {
    /// Matchmaker captcha configuration.
    pub fn new() -> CommonsMatchmakerCaptcha {
