...
pub struct CloudVersionMatchmakerCaptchaTurnstile {
	...
	pub domains: ::std::collections::HashMap<
		String,
		crate::models::CloudVersionMatchmakerCaptchaTurnstileDomain,
	>,
}
...
impl CloudVersionMatchmakerCaptchaTurnstile {
	...
	pub fn new(
		domains: ::std::collections::HashMap<
			String,
			crate::models::CloudVersionMatchmakerCaptchaTurnstileDomain,
		>,
	) -> CloudVersionMatchmakerCaptchaTurnstile {
		CloudVersionMatchmakerCaptchaTurnstile { domains }
	}
}
