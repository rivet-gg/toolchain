...
/// CommonsMatchmakerNamespaceConfig : Matchmaker configuration for a given namespace.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CommonsMatchmakerNamespaceConfig {
...
impl CommonsMatchmakerNamespaceConfig {
    /// Matchmaker configuration for a given namespace.
    pub fn new() -> CommonsMatchmakerNamespaceConfig {
        CommonsMatchmakerNamespaceConfig {
