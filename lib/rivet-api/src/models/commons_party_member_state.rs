...
pub struct CommonsPartyMemberState {
    ...
    pub matchmaker_lobby: Option<Box<crate::models::CommonsPartyMemberStateMatchmakerLobby>>,
}

impl CommonsPartyMemberState {
    pub fn new() -> CommonsPartyMemberState {
