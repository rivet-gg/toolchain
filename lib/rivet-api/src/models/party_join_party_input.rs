...
pub struct PartyJoinPartyInput {
    #[serde(rename = "invite")]
    pub invite: Box<crate::models::PartyJoinPartyInvite>,
...
impl PartyJoinPartyInput {
    pub fn new(invite: crate::models::PartyJoinPartyInvite) -> PartyJoinPartyInput {
        PartyJoinPartyInput {
