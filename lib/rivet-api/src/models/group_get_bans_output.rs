...
impl GroupGetBansOutput {
    pub fn new(banned_identities: Vec<crate::models::GroupBannedIdentity>, watch: crate::models::WatchResponse) -> GroupGetBansOutput {
        GroupGetBansOutput {
            anchor: None,
            banned_identities,
            watch: Box::new(watch),
