...
/// CloudMatchmakerCaptcha : Matchmaker captcha configuration.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CloudMatchmakerCaptcha {
    ...
    pub hcaptcha: Option<Box<crate::models::CloudMatchmakerCaptchaHcaptcha>>,
}

impl CloudMatchmakerCaptcha {
    /// Matchmaker captcha configuration.
    pub fn new() -> CloudMatchmakerCaptcha {
