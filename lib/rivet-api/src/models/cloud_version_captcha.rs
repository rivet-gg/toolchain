...
/// CloudVersionCaptcha : Matchmaker captcha configuration.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CloudVersionCaptcha {
    #[serde(rename = "hcaptcha", skip_serializing_if = "Option::is_none")]
    pub hcaptcha: Option<Box<crate::models::CloudVersionCaptchaHcaptcha>>,
...
impl CloudVersionCaptcha {
    /// Matchmaker captcha configuration.
    pub fn new() -> CloudVersionCaptcha {
        CloudVersionCaptcha {
            hcaptcha: None,
