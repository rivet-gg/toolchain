...
pub struct ChatWatchThreadOutput {
...
impl ChatWatchThreadOutput {
    pub fn new(chat_messages: Vec<crate::models::ChatMessage>, watch: crate::models::WatchResponse) -> ChatWatchThreadOutput {
