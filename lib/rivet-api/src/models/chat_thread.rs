...
impl ChatThread {
    /// A chat thread
    pub fn new(create_ts: String, external: crate::models::ChatThreadExternalLinks, last_read_ts: String, thread_id: uuid::Uuid, topic: crate::models::ChatTopic, unread_count: i32) -> ChatThread {
        ChatThread {
            create_ts,
