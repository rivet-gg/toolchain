...
/// CloudLobbyGroup : A game mode.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CloudLobbyGroup {
    /// A human readable short identifier used to references resources. Different than a `rivet.common#Uuid` because this is intended to be human readable. Different than `rivet.common#DisplayName` because this should not include special characters and be short.
    #[serde(rename = "name_id")]
    pub name_id: String,
    /// A list of game mode regions.
    #[serde(rename = "regions")]
    pub regions: Vec<crate::models::CloudLobbyGroupRegion>,
    ...
    pub runtime: Box<crate::models::CloudLobbyGroupRuntime>,
}

impl CloudLobbyGroup {
    /// A game mode.
    pub fn new(name_id: String, regions: Vec<crate::models::CloudLobbyGroupRegion>, runtime: crate::models::CloudLobbyGroupRuntime) -> CloudLobbyGroup {
        CloudLobbyGroup {
            name_id,
            regions,
