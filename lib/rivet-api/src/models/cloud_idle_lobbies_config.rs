...
/// CloudIdleLobbiesConfig : Configuration for how many idle lobbies a game version should have.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CloudIdleLobbiesConfig {
...
impl CloudIdleLobbiesConfig {
    /// Configuration for how many idle lobbies a game version should have.
    pub fn new() -> CloudIdleLobbiesConfig {
        CloudIdleLobbiesConfig {
