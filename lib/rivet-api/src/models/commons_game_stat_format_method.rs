...
/// CommonsGameStatFormatMethod : A value denoting the format method of a game statistic.

/// A value denoting the format method of a game statistic.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum CommonsGameStatFormatMethod {
...
impl ToString for CommonsGameStatFormatMethod {
...
impl Default for CommonsGameStatFormatMethod {
    fn default() -> CommonsGameStatFormatMethod {
        Self::Integer
    }
}
