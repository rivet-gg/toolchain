...
impl PartyProfile {
    pub fn new(activity: crate::models::PartyActivity, create_ts: String, external: crate::models::PartyExternalLinks, invites: Vec<crate::models::PartyInvite>, members: Vec<crate::models::PartyMemberSummary>, party_id: String, publicity: crate::models::PartyPublicity, thread_id: String) -> PartyProfile {
        PartyProfile {
