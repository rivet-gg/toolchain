...
/// PartyCreatePartyInviteConfig : Configuration for creating a party invite.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct PartyCreatePartyInviteConfig {
...
impl PartyCreatePartyInviteConfig {
    /// Configuration for creating a party invite.
    pub fn new() -> PartyCreatePartyInviteConfig {
