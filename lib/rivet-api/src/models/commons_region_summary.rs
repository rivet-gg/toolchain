...
/// CommonsRegionSummary : A region summary.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CommonsRegionSummary {
...
impl CommonsRegionSummary {
    /// A region summary.
    pub fn new(region_id: String, region_name_id: String, provider: String, provider_display_name: String, region_display_name: String) -> CommonsRegionSummary {
