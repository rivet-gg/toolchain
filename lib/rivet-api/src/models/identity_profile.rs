...
impl IdentityProfile {
    /// An identity profile.
    pub fn new(account_number: i32, avatar_url: String, bio: String, display_name: String, external: crate::models::IdentityExternalLinks, follower_count: i32, following: bool, following_count: i32, games: Vec<crate::models::GameStatSummary>, groups: Vec<crate::models::IdentityGroup>, identity_id: uuid::Uuid, is_admin: bool, is_following_me: bool, is_mutual_following: bool, is_registered: bool, join_ts: String, linked_accounts: Vec<crate::models::IdentityLinkedAccount>) -> IdentityProfile {
        IdentityProfile {
            account_number,
            avatar_url,
            bio,
