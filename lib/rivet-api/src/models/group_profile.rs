...
impl GroupProfile {
    ...
    pub fn new(bio: String, display_name: String, external: crate::models::GroupExternalLinks, group_id: String, join_requests: Vec<crate::models::GroupJoinRequest>, members: Vec<crate::models::GroupMember>, owner_identity_id: String, publicity: crate::models::GroupPublicity) -> GroupProfile {
        GroupProfile {
            avatar_url: None,
            bio,
            display_name,
