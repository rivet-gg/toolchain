...
pub struct MatchmakerRegionInfo {
    ...
    pub datacenter_coord: Box<crate::models::CommonsCoord>,
    #[serde(rename = "datacenter_distance_from_client")]
    pub datacenter_distance_from_client: Box<crate::models::CommonsDistance>,
}

impl MatchmakerRegionInfo {
    /// A region that the player can connect to.
    pub fn new(region_id: String, provider_display_name: uuid::Uuid, region_display_name: uuid::Uuid, datacenter_coord: crate::models::CommonsCoord, datacenter_distance_from_client: crate::models::CommonsDistance) -> MatchmakerRegionInfo {
