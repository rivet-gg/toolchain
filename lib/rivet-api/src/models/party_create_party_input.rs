...
pub struct PartyCreatePartyInput {
    ...
    pub publicity: Option<Box<crate::models::PartyCreatePartyPublicityConfig>>,
    #[serde(rename = "invites", skip_serializing_if = "Option::is_none")]
    pub invites: Option<Vec<crate::models::PartyCreatePartyInviteConfig>>,
...
impl PartyCreatePartyInput {
    pub fn new() -> PartyCreatePartyInput {
