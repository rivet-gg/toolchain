...
pub struct CloudGetBillingResponse {
...
impl CloudGetBillingResponse {
	pub fn new(
		available_regions: Vec<crate::models::CloudRegionSummary>,
		bank_source: crate::models::CloudGroupBankSource,
		billing: crate::models::CloudGroupBillingSummary,
	) -> CloudGetBillingResponse {
		CloudGetBillingResponse {
			available_regions,
