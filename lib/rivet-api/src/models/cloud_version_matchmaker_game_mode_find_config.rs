...
pub struct CloudVersionMatchmakerGameModeFindConfig {
	...
	#[serde(
		rename = "verification_config",
		skip_serializing_if = "Option::is_none"
	)]
	pub verification_config:
		Option<Box<crate::models::CloudVersionMatchmakerGameModeVerificationConfig>>,
}
...
impl CloudVersionMatchmakerGameModeFindConfig {
	...
	pub fn new(
		enabled: bool,
		identity_requirement: crate::models::CloudVersionMatchmakerGameModeIdentityRequirement,
