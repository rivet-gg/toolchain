...
impl LobbyGroupRuntimeDocker {
    pub fn new(build_id: String, args: Vec<String>, ports: Vec<crate::models::LobbyGroupRuntimeDockerPorts>, env_vars: Vec<crate::models::LobbyGroupRuntimeDockerEnvVars>) -> LobbyGroupRuntimeDocker {
