...
impl MatchmakerNamespaceConfig {
    pub fn new(lobby_count_max: i32, max_players_per_client: i32, max_players_per_client_vpn: i32, max_players_per_client_proxy: i32, max_players_per_client_tor: i32, max_players_per_client_hosting: i32) -> MatchmakerNamespaceConfig {
