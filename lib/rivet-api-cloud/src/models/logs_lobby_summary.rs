...
impl LogsLobbySummary {
    pub fn new(lobby_id: String, namespace_id: String, lobby_group_name_id: String, region_id: String, create_ts: i64, status: crate::models::LogsLobbyStatus) -> LogsLobbySummary {
        LogsLobbySummary {
            lobby_id,
            namespace_id,
            lobby_group_name_id,
