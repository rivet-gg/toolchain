...
) -> Result<crate::models::InlineResponse20011, Error<CreateGameBuildError>> {
    let local_var_client = &configuration.client;
...
) -> Result<crate::models::InlineResponse2009, Error<CreateGameCdnSiteError>> {
    let local_var_client = &configuration.client;
...
pub async fn list_cdn_sites(
    configuration: &configuration::Configuration,
    game_id: &str,
) -> Result<crate::models::InlineResponse2008, Error<ListCdnSitesError>> {
    let local_var_client = &configuration.client;
...
pub async fn list_game_builds(
    configuration: &configuration::Configuration,
    game_id: &str,
) -> Result<crate::models::InlineResponse20010, Error<ListGameBuildsError>> {
    let local_var_client = &configuration.client;
...
) -> Result<crate::models::InlineObject3, Error<UpdateGameNamespaceVersionError>> {
    let local_var_client = &configuration.client;
