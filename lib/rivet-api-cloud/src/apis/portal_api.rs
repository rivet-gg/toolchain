...
/// struct for typed errors of method [`get_ray_perf_logs`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetRayPerfLogsError {
	Status400(crate::models::ResponseError),
	Status401(crate::models::ResponseError),
	Status403(crate::models::ResponseError),
	Status404(crate::models::ResponseError),
...
pub async fn convert_team(
	configuration: &configuration::Configuration,
	team_id: &str,
	body: serde_json::Value,
) -> Result<(), Error<ConvertTeamError>> {
	let local_var_configuration = configuration;

	let local_var_client = &local_var_configuration.client;

	let local_var_uri_str = format!(
		"{}/teams/{team_id}/convert",
		local_var_configuration.base_path,
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ConvertTeamError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn create_cloud_token(
	...
	game_id: &str,
	body: serde_json::Value,
) -> Result<crate::models::InlineResponse2007, Error<CreateCloudTokenError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CreateCloudTokenError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
) -> Result<crate::models::InlineResponse200AgentGameCloud, Error<CreateGameError>> {
	let local_var_configuration = configuration;
...
pub async fn create_game_build(
	configuration: &configuration::Configuration,
	game_id: &str,
	inline_object8: crate::models::InlineObject8,
) -> Result<crate::models::InlineResponse20014, Error<CreateGameBuildError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CreateGameBuildError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn create_game_cdn_site(
	configuration: &configuration::Configuration,
	game_id: &str,
	inline_object7: crate::models::InlineObject7,
) -> Result<crate::models::InlineResponse20012, Error<CreateGameCdnSiteError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CreateGameCdnSiteError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn create_game_namespace(
	configuration: &configuration::Configuration,
	game_id: &str,
	inline_object2: crate::models::InlineObject2,
) -> Result<crate::models::InlineResponse2005, Error<CreateGameNamespaceError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CreateGameNamespaceError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn create_game_namespace_token_development(
	configuration: &configuration::Configuration,
	game_id: &str,
	namespace_id: &str,
	inline_object4: crate::models::InlineObject4,
) -> Result<crate::models::InlineResponse2007, Error<CreateGameNamespaceTokenDevelopmentError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CreateGameNamespaceTokenDevelopmentError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn create_game_namespace_token_public(
	configuration: &configuration::Configuration,
	game_id: &str,
	namespace_id: &str,
	body: serde_json::Value,
) -> Result<crate::models::InlineResponse2007, Error<CreateGameNamespaceTokenPublicError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CreateGameNamespaceTokenPublicError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn create_game_version(
...
) -> Result<crate::models::InlineResponse2003, Error<CreateGameVersionError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CreateGameVersionError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn delete_matchmaker_lobby(
	configuration: &configuration::Configuration,
	game_id: &str,
	lobby_id: &str,
) -> Result<crate::models::InlineResponse20015, Error<DeleteMatchmakerLobbyError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<DeleteMatchmakerLobbyError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn export_matchmaker_lobby_history(
	configuration: &configuration::Configuration,
	game_id: &str,
	matchmaker_lobbies_export_history_request: crate::models::MatchmakerLobbiesExportHistoryRequest,
) -> Result<
	crate::models::MatchmakerLobbiesExportHistoryResponse,
	Error<ExportMatchmakerLobbyHistoryError>,
> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ExportMatchmakerLobbyHistoryError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn get_game_by_id(
	configuration: &configuration::Configuration,
	game_id: &str,
) -> Result<crate::models::InlineResponse2002, Error<GetGameByIdError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GetGameByIdError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn get_game_namespace_by_id(
	configuration: &configuration::Configuration,
	game_id: &str,
	namespace_id: &str,
) -> Result<crate::models::InlineResponse2006, Error<GetGameNamespaceByIdError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GetGameNamespaceByIdError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn get_game_version_by_id(
	configuration: &configuration::Configuration,
	game_id: &str,
	version_id: &str,
) -> Result<crate::models::InlineResponse2004, Error<GetGameVersionByIdError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GetGameVersionByIdError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn get_games(
	configuration: &configuration::Configuration,
) -> Result<crate::models::InlineResponse2001, Error<GetGamesError>> {
	let local_var_configuration = configuration;
...
pub async fn get_namespace_analytics_matchmaker_live(
	configuration: &configuration::Configuration,
	game_id: &str,
	namespace_id: &str,
) -> Result<crate::models::InlineResponse2008, Error<GetNamespaceAnalyticsMatchmakerLiveError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GetNamespaceAnalyticsMatchmakerLiveError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn get_namespace_lobby(
	configuration: &configuration::Configuration,
	game_id: &str,
	namespace_id: &str,
	lobby_id: &str,
) -> Result<crate::models::InlineResponse20010, Error<GetNamespaceLobbyError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GetNamespaceLobbyError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn get_ray_perf_logs(
	configuration: &configuration::Configuration,
	ray_id: &str,
) -> Result<crate::models::InlineResponse20021, Error<GetRayPerfLogsError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GetRayPerfLogsError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn get_region_tiers(
	configuration: &configuration::Configuration,
) -> Result<crate::models::InlineResponse20020, Error<GetRegionTiersError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GetRegionTiersError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn get_team_bank_transfers_list(
	configuration: &configuration::Configuration,
	team_id: &str,
	start_transfer_id: Option<&str>,
) -> Result<crate::models::InlineResponse20018, Error<GetTeamBankTransfersListError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GetTeamBankTransfersListError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn get_team_billing(
...
) -> Result<crate::models::InlineResponse20016, Error<GetTeamBillingError>> {
	let local_var_configuration = configuration;

	let local_var_client = &local_var_configuration.client;

	let local_var_uri_str = format!(
		"{}/teams/{team_id}/billing",
		local_var_configuration.base_path,
		team_id = crate::apis::urlencode(team_id)
	);
	let mut local_var_req_builder =
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GetTeamBillingError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn get_team_payments_list(
	configuration: &configuration::Configuration,
	team_id: &str,
	start_payment_id: Option<&str>,
) -> Result<crate::models::InlineResponse20017, Error<GetTeamPaymentsListError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GetTeamPaymentsListError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn inspect(
	configuration: &configuration::Configuration,
) -> Result<crate::models::InlineResponse200, Error<InspectError>> {
	let local_var_configuration = configuration;
...
pub async fn list_cdn_sites(
	configuration: &configuration::Configuration,
	game_id: &str,
) -> Result<crate::models::InlineResponse20011, Error<ListCdnSitesError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ListCdnSitesError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn list_game_builds(
	configuration: &configuration::Configuration,
	game_id: &str,
) -> Result<crate::models::InlineResponse20013, Error<ListGameBuildsError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ListGameBuildsError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn list_namespace_lobbies(
	configuration: &configuration::Configuration,
	game_id: &str,
	namespace_id: &str,
	before_create_ts: Option<i64>,
) -> Result<crate::models::InlineResponse2009, Error<ListNamespaceLobbiesError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ListNamespaceLobbiesError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn remove_namespace_domain(
	...
	namespace_id: &str,
	domain: &str,
) -> Result<serde_json::Value, Error<RemoveNamespaceDomainError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<RemoveNamespaceDomainError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn team_billing_checkout(
	configuration: &configuration::Configuration,
	team_id: &str,
	inline_object9: crate::models::InlineObject9,
) -> Result<crate::models::InlineResponse20019, Error<TeamBillingCheckoutError>> {
	let local_var_configuration = configuration;

	let local_var_client = &local_var_configuration.client;

	let local_var_uri_str = format!(
		"{}/teams/{team_id}/checkout",
		local_var_configuration.base_path,
		team_id = crate::apis::urlencode(team_id)
	);
	let mut local_var_req_builder =
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<TeamBillingCheckoutError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn toggle_namespace_domain_public_auth(
	configuration: &configuration::Configuration,
	game_id: &str,
	namespace_id: &str,
	inline_object5: crate::models::InlineObject5,
) -> Result<serde_json::Value, Error<ToggleNamespaceDomainPublicAuthError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ToggleNamespaceDomainPublicAuthError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn update_game_namespace_matchmaker_config(
	configuration: &configuration::Configuration,
	game_id: &str,
	namespace_id: &str,
	inline_object6: crate::models::InlineObject6,
) -> Result<serde_json::Value, Error<UpdateGameNamespaceMatchmakerConfigError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<UpdateGameNamespaceMatchmakerConfigError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn update_game_namespace_version(
	configuration: &configuration::Configuration,
	game_id: &str,
	namespace_id: &str,
	inline_object3: crate::models::InlineObject3,
) -> Result<serde_json::Value, Error<UpdateGameNamespaceVersionError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<UpdateGameNamespaceVersionError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn update_namespace_domain(
	configuration: &configuration::Configuration,
	game_id: &str,
	namespace_id: &str,
	domain: &str,
	body: serde_json::Value,
) -> Result<serde_json::Value, Error<UpdateNamespaceDomainError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<UpdateNamespaceDomainError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn validate_game(
...
) -> Result<crate::models::ValidationErrors, Error<ValidateGameError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ValidateGameError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn validate_game_namespace(
	configuration: &configuration::Configuration,
	game_id: &str,
	inline_object11: crate::models::InlineObject11,
) -> Result<crate::models::ValidationErrors, Error<ValidateGameNamespaceError>> {
	let local_var_configuration = configuration;

	let local_var_client = &local_var_configuration.client;

	let local_var_uri_str = format!(
		"{}/games/{game_id}/namespace/validate",
		local_var_configuration.base_path,
		game_id = crate::apis::urlencode(game_id)
	);
	let mut local_var_req_builder =
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ValidateGameNamespaceError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn validate_game_namespace_matchmaker_config(
	configuration: &configuration::Configuration,
	game_id: &str,
	namespace_id: &str,
	inline_object15: crate::models::InlineObject15,
) -> Result<crate::models::ValidationErrors, Error<ValidateGameNamespaceMatchmakerConfigError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ValidateGameNamespaceMatchmakerConfigError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn validate_game_namespace_token_development(
	configuration: &configuration::Configuration,
	game_id: &str,
	namespace_id: &str,
	inline_object14: crate::models::InlineObject14,
) -> Result<crate::models::ValidationErrors, Error<ValidateGameNamespaceTokenDevelopmentError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ValidateGameNamespaceTokenDevelopmentError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn validate_game_version(
	configuration: &configuration::Configuration,
	game_id: &str,
	inline_object10: crate::models::InlineObject10,
) -> Result<crate::models::ValidationErrors, Error<ValidateGameVersionError>> {
	let local_var_configuration = configuration;

	let local_var_client = &local_var_configuration.client;

	let local_var_uri_str = format!(
		"{}/games/{game_id}/version/validate",
		local_var_configuration.base_path,
		game_id = crate::apis::urlencode(game_id)
	);
	let mut local_var_req_builder =
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ValidateGameVersionError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn validate_team(
...
) -> Result<crate::models::ValidationErrors, Error<ValidateTeamError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ValidateTeamError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
