	...
	> {
		let mut request = {
			...
			fn uri_query(
				...
				if let Some(inner_28) = &_input.watch_index {
					query.push_kv(
						"watch_index",
	...
	> {
		let mut request = {
			fn uri_base(
				...
				let game_id = aws_smithy_http::label::fmt_string(input_29, false);
				if game_id.is_empty() {
					return Err(aws_smithy_http::operation::BuildError::MissingField {
						field: "game_id",
						details: "cannot be empty or unset",
				...
				let input_30 = &_input.namespace_id;
				...
				let namespace_id = aws_smithy_http::label::fmt_string(input_30, false);
				if namespace_id.is_empty() {
					return Err(aws_smithy_http::operation::BuildError::MissingField {
						field: "namespace_id",
						details: "cannot be empty or unset",
	...
	> {
		let mut request = {
			...
			fn uri_query(
				...
				let mut query = aws_smithy_http::query::Writer::new(&mut output);
				if let Some(inner_31) = &_input.watch_index {
					query.push_kv(
						"watch_index",
	...
	> {
		let mut request = {
			fn uri_base(
				...
				let game_id = aws_smithy_http::label::fmt_string(input_32, false);
				if game_id.is_empty() {
					return Err(aws_smithy_http::operation::BuildError::MissingField {
						field: "game_id",
						details: "cannot be empty or unset",
				...
				let input_33 = &_input.version_id;
				...
				let version_id = aws_smithy_http::label::fmt_string(input_33, false);
	...
	> {
		let mut request = {
			...
			fn uri_query(
				...
				let mut query = aws_smithy_http::query::Writer::new(&mut output);
				if let Some(inner_35) = &_input.query_start {
					query.push_kv(
						"query_start",
						aws_smithy_types::primitive::Encoder::from(*inner_35).encode(),
					);
				}
				if let Some(inner_36) = &_input.query_end {
					query.push_kv(
						"query_end",
