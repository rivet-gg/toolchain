	...
	> {
		let mut request = {
			fn uri_base(
				...
				let lobby_id = aws_smithy_http::label::fmt_string(input_15, false);
	...
	> {
		let mut request = {
			fn uri_base(
				...
				let game_id = aws_smithy_http::label::fmt_string(input_19, false);
				if game_id.is_empty() {
					return Err(aws_smithy_http::operation::BuildError::MissingField {
						field: "game_id",
						details: "cannot be empty or unset",
				...
				let upload_id = aws_smithy_http::label::fmt_string(input_20, false);
				if upload_id.is_empty() {
					return Err(aws_smithy_http::operation::BuildError::MissingField {
						field: "upload_id",
						details: "cannot be empty or unset",
	...
	> {
		let mut request = {
			fn uri_base(
				...
				let upload_id = aws_smithy_http::label::fmt_string(input_23, false);
				if upload_id.is_empty() {
					return Err(aws_smithy_http::operation::BuildError::MissingField {
						field: "upload_id",
						details: "cannot be empty or unset",
	...
	> {
		let mut request = {
			fn uri_base(
				...
				let game_id = aws_smithy_http::label::fmt_string(input_25, false);
				if game_id.is_empty() {
					return Err(aws_smithy_http::operation::BuildError::MissingField {
						field: "game_id",
						details: "cannot be empty or unset",
			...
			fn uri_query(
				...
				if let Some(inner_26) = &_input.watch_index {
					query.push_kv(
						"watch_index",
	...
	> {
		let mut request = {
			fn uri_base(
				...
				let input_28 = &_input.namespace_id;
				...
				let namespace_id = aws_smithy_http::label::fmt_string(input_28, false);
				if namespace_id.is_empty() {
					return Err(aws_smithy_http::operation::BuildError::MissingField {
						field: "namespace_id",
						details: "cannot be empty or unset",
	...
	> {
		let mut request = {
			fn uri_base(
				...
				let group_id = aws_smithy_http::label::fmt_string(input_32, false);
				if group_id.is_empty() {
					return Err(aws_smithy_http::operation::BuildError::MissingField {
						field: "group_id",
						details: "cannot be empty or unset",
			...
			fn uri_query(
				...
				let mut query = aws_smithy_http::query::Writer::new(&mut output);
				if let Some(inner_33) = &_input.query_start {
					query.push_kv(
						"query_start",
						aws_smithy_types::primitive::Encoder::from(*inner_33).encode(),
					);
				}
				if let Some(inner_34) = &_input.query_end {
					query.push_kv(
						"query_end",
	...
	> {
		let mut request = {
			fn uri_base(
				...
				let group_id = aws_smithy_http::label::fmt_string(input_35, false);
				if group_id.is_empty() {
					return Err(aws_smithy_http::operation::BuildError::MissingField {
						field: "group_id",
						details: "cannot be empty or unset",
			...
			fn uri_query(
				...
				let mut query = aws_smithy_http::query::Writer::new(&mut output);
				if let Some(inner_36) = &_input.anchor {
					query.push_kv("anchor", &aws_smithy_http::query::fmt_string(&inner_36));
				}
	...
	> {
		let mut request = {
			...
			fn uri_query(
				...
				let mut query = aws_smithy_http::query::Writer::new(&mut output);
				if let Some(inner_39) = &_input.start_payment_id {
					query.push_kv(
						"start_payment_id",
	...
	> {
		let mut request = {
			...
			fn uri_query(
				...
				let mut query = aws_smithy_http::query::Writer::new(&mut output);
				if let Some(inner_41) = &_input.start_transfer_id {
					query.push_kv(
						"start_transfer_id",
