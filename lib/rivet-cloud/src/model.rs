...
/// See [`GroupBillingSummary`](crate::model::GroupBillingSummary)
pub mod group_billing_summary {
	/// A builder for [`GroupBillingSummary`](crate::model::GroupBillingSummary)
	#[non_exhaustive]
	#[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug)]
	pub struct Builder {
...
impl GroupBillingSummary {
	/// Creates a new builder-style object to manufacture [`GroupBillingSummary`](crate::model::GroupBillingSummary)
	pub fn builder() -> crate::model::group_billing_summary::Builder {
		crate::model::group_billing_summary::Builder::default()
	}
}
