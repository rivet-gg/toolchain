...
function Content() {
    ...
    return (
      <Container>
        ...
        <div className="flex gap-2">
          <WithTooltip
            content="Configuration will be saved to your rivet.json file"
            trigger={
              <Button
  ...
  if (state?.value === "failure") {
      ...
      return (
        <Container>
          <div className="flex justify-between w-full items-center">
            <p>
              <Strong>Rivet server has failed to start.</Strong> Modules (
    ...
    return (
      <Container>
        <Strong>Rivet server has failed to start.</Strong> Please check the logs for more information.
      </Container>
    );
  }
