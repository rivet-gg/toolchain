# Used for testing the game server on Rivet with logging & debug information enabled.
...
# Run the game server
ENTRYPOINT ["unbuffer", "/home/nonroot/project/__GAME_MODULE__/Binaries/Linux/__GAME_MODULE__Server", "__GAME_MODULE__", "-server", "-log"]
